...
<head>
  ...
  <title>Verify your email – Altered Re:Union</title>
  ...
  <style>
    ...
    .btn { display: inline-block; padding: 13px 36px; background: linear-gradient(135deg, #00c2d4, #0097a7); border-radius: 8px; color: #080c17 !important; font-size: 15px; font-weight: 600; text-decoration: none; letter-spacing: 0.02em; }
...
<div class="wrapper">
  <table class="container" width="520" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td class="body">
        <p>Hello,</p>
        <p>Thank you for creating your Altered Re:Union account. Please verify your email address by clicking the button below.</p>
        <div class="btn-wrap">
    ...
    <tr>
      <td class="footer">
        <p>You received this email because an account was created with this address on <strong>altered.re</strong>.<br>
